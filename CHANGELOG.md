...
* Added Hungarian language (Magyar, hu-HU, thanks to @gattyan61)

* Added Chinese (Traditional) language (中文（繁體）, zh-Hant, thanks to @Palatis)
...
* Improved proximity sensor handling in case no proximity is available
